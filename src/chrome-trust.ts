...
export const CHROME_TRUST_ENV_VAR = "OMO_CODEX_CHROME_TRUST";
...
const TRUST_DIR_NAME = "omo-codex-computer";
...
/**
 * Write via temp file + rename so concurrent OMO sessions never observe a
 ...
 * OMO_CODEX_CHROME_TRUST as a comma-separated list of app-server versions.
